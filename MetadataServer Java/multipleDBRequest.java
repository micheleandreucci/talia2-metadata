	...
	public void loadAllJsonData(DocumentListJson json_object) throws SQLException, ParseException,
		...
		try {
			...
			for (Document document : json_object.getDocuments()) {
				...
				System.out.println(project_acronym);
			...
			System.err.println("Non riesco a caricare il json " + e);
			e.printStackTrace();
		}
	}

	public static void main(String args[]) {
		Json_Parser jParse = new Json_Parser(
				"C:\\Users\\user\\eclipse-workspace-Java\\talia2-metadata\\Social and Creative", "Social and Creative");
