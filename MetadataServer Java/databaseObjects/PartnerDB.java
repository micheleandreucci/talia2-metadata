...
/*
 * gestire i dati contenuti nelle basi di dati
 */
public class PartnerDB {
	int partner_id;
	boolean is_lead_partner;
	String partner_name;
	String partner_nature;
	String partner_country;
	String partner_postalCode;
	String partner_area;
	String nuts3;
	String partner_city;
	String partner_address;
	double erdf;
	double erdfContribution;
	double ipa_funds;
	double ipaContribution;
	double partner_amount;
